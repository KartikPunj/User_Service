package com.ecommerce.user_service_self.security;
...
//                .username("user")
//                .password("$2a$16$TEAhR19YpAoz2rHa3rXyw.8Dl9BWzVg1k/D/.YS5FYyvzx8RyQ5l2")
//                .roles("USER")
//                .build();
//
//        return new InMemoryUserDetailsManager(userDetails);
//    }
// I no longer needed this in memory client repository as now i have linked my client repository with the database using
    // client repository code of spring security i.e security>repository>ClientRepository.java
//    @Bean
        ...
        return (context) -> {
            if (OAuth2TokenType.ACCESS_TOKEN.equals(context.getTokenType())) {
                context.getClaims().claims((claims) -> {
                    ...
                    // here in the above line this context.getPrincipal() thing is actually the customUserDetails object
                    // that we are getting from the database
